            ...
            if (id == R.id.tvConfirm) {
                if (tvConfirm.getText().toString().equals("关闭")) {
                    ...
                    if (convertResult.isSuccess) {
                        ...
                        if (null != keyboardFragmentListener) {
                            keyboardFragmentListener.inputComplete(convertResult.message);
                        }
...
//删除按钮
    ...
    public interface KeyboardFragmentListener {
        void inputComplete(String inputContent);
    }

    public void setKeyboardFragmentListener(KeyboardFragmentListener keyboardFragmentListener) {
